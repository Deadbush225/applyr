  ...
  return (
    <div className="modal-backdrop center-align" role="dialog" aria-modal="true" aria-labelledby="past-application-date-title">
      <div className="modal">
        ...
        <p>You are viewing a job application that is past its application date. Any changes aside from the <b>application status</b> will not be synced to the database unless you update the job application date.
        <br /><br />
